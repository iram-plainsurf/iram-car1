$(document).ready(function(){
  ...
  $("#btn_clear").on('click',function()
  {
        ...
        var e_id=$("#txt_customer_id").val();
          ...
          if (txt_customer_name != "") 
          {
            if (txt_contact != "") 
            {
              if (txt_price != "") 
              {
                $.post("assets/php/save_customers.php",{action:"update",id:e_id,txt_customer_name:txt_customer_name,txt_address:txt_address,txt_contact:txt_contact,txt_model:txt_model,txt_price:txt_price,txt_payment:txt_payment},function(res)
                {
                   console.log(res);
                  if (res>0) 
                  {
   ...
   function loadEmployee()
     {        
      $.post("assets/php/save_customers.php",{action:"fetchData"},function(res)
      {
           $("#loadData").html(res);
      });
     }
  ...
  function getEmployee(ele)
    {
      ...
      $.post("assets/php/save_customers.php",{action:"getRow",c_id:id},function(res){
        //console.log(res);
    ...
    {  
      ...
      var id=parseInt(code);
        ...
        if (r==true) 
        {
        $.post("assets/php/save_customers.php",{action:"delete",c_id:id},function(res)
        {
           console.log(res);
           if(res>0)  
           {
